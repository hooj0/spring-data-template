...
public class ExpressionEvaluatingParameterBinder {
	...
	static class BindingContext {
		...
		final TemplateQueryMethod queryMethod;
		final List<ParameterBinding> bindings;

		/**
		 * Creates new {@link BindingContext}.
		 * @param queryMethod
		 *            {@link TemplateQueryMethod} on which the parameters are evaluated.
		 * @param bindings
		 ...
		 */
		public BindingContext(TemplateQueryMethod queryMethod, List<ParameterBinding> bindings) {
		 ...
		 * @return the {@link TemplateParameters} associated with the {@link TemplateQueryMethod}.
		 */
		...
		/**
		 * Get the {@link TemplateQueryMethod}.
		 * @return the {@link TemplateQueryMethod} used in the expression evaluation context.
		 */
		TemplateQueryMethod getQueryMethod() {
			return queryMethod;
		}
	}
